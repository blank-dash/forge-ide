...
const RU: Record<string, string> = {
  ...
  /* Pickers, search and checkpoints */
  'Go to file…': 'Перейти к файлу…',
  'Go to file': 'Перейти к файлу',
  'No file matches that.': 'Нет подходящих файлов.',
  'Type a command…': 'Введите команду…',
  'No command matches that.': 'Нет подходящих команд.',
  'Go to symbol…': 'Перейти к символу…',
  'Go to symbol': 'Перейти к символу',
  'No symbols found in this file.': 'В этом файле символов не нашлось.',
  Search: 'Поиск',
  'Search across files': 'Поиск по файлам',
  'Files to include, e.g. *.ts': 'Где искать, например *.ts',
  'Match case': 'Учитывать регистр',
  'Regular expression': 'Регулярное выражение',
  'searching…': 'ищу…',
  files: 'файлах',
  'Nothing found.': 'Ничего не найдено.',
  'Stopped early — there are more matches than can be shown. Narrow the search.':
    'Остановлено — совпадений больше, чем можно показать. Уточните запрос.',
  ...
  'Every turn that changed a file is recorded here. Restoring one puts those files back to how they were before that turn — including files it created, which are removed again.':
    'Здесь записан каждый ход, который что-то изменил. Откат возвращает те файлы в состояние до этого хода — включая созданные, они удаляются.',
  'Nothing to undo yet.': 'Откатывать пока нечего.',
  'A checkpoint is written whenever a turn changes something on disk.':
    'Точка записывается всякий раз, когда ход что-то меняет на диске.',
  Restore: 'Откатить',
  'Restoring…': 'Откатываю…',
  'Put these files back': 'Вернуть эти файлы',
  Restored: 'Возвращено',
  'could not be restored': 'не удалось вернуть',
  file: 'файл',
  'Switch to Chat': 'Перейти в Чат',
  'Switch to Work': 'Перейти в Работу',
  'Toggle terminal': 'Терминал',
  'Toggle sidebar': 'Боковая панель',
  'Review changes': 'Проверить изменения',
  'Export this conversation to Markdown': 'Выгрузить диалог в Markdown',
  'Settings: Providers & models': 'Настройки: провайдеры и модели',
  'Settings: Voice': 'Настройки: голос',
  'Settings: Appearance': 'Настройки: внешний вид',
  'Settings: Prompt library': 'Настройки: библиотека промптов',
  'Settings: Permissions': 'Настройки: разрешения',
  'Read-only: look but do not touch': 'Только чтение: смотреть, не трогать',
  'Allow edits again': 'Снова разрешить правки',
  'Approve everything without asking': 'Одобрять всё без вопросов',
  Spending: 'Расходы',
  ...
  'Prompts you type often, kept where you can reach them. Each one appears in the composer as a slash command and fills the box, so you can add the specifics before sending.':
    'Запросы, которые вы пишете часто, лежат под рукой. Каждый появляется в поле ввода как команда со слэшем и подставляет свой текст — детали дописываете перед отправкой.',
  'Typed as': 'Вызывается как',
  'What it is for': 'Для чего',
  'Shown beside the name': 'Показывается рядом с именем',
  'The prompt itself': 'Сам запрос',
  'Add a prompt': 'Добавить запрос',
  Type: 'Наберите',
  'in the composer.': 'в поле ввода.',
